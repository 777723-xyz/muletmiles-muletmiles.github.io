...
Game_Interpreter.prototype.pluginCommand = function(command, args) {
	...
	if (command === "setEnemyTarget") {
		//$windowBattleEnemy.select(Number(args[1]);
		//Window_BattleEnemy.select(Number(args[1]);
		//$gameTemp._bcam_target = $gameTemp.Scene_Battle._enemyWindow.select(args[1]);
		// $gameTemp._bcam_user = [null,[5000,args[1]]];
		// $gameTemp._bcam_actor = [null,[0,0]];
		...
		// $gameTemp._bcam_phase = [0,0,0,0,0];
