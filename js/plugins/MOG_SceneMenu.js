...
ImageManager.loadMenusMainCommands = function(filename) {
	//return this.loadBitmap('img/menus/main/commands/', "Equip", 0, true);
    return this.loadBitmap('img/menus/main/commands/', String(filename), 0, true);
};		
...
Scene_Menu.prototype.loadBitmapsMain = function() {
    ...
    for (var i = 0; i < this._comList.length; i++) {
		 this._comBitmaps[i] = ImageManager.loadMenusMainCommands(String(this._comList[i].name));
		 //this._comBitmaps[i] = ImageManager.loadMenusMainCommands(i);
    };
